<!DOCTYPE html>
<html lang="fr">
    <!-- url: http://php.localhost/form1_get.php -->
    <head>
            ...
            <div id="formulaire" class="form">
                <form action="form1_get.php" method="get">
                    ...
                    <p>
                        ...
                        <input type="email" id="email" name="email" value="<?php if(isset($_GET['email'])) {echo $_GET['email'];}?>" required autocomplete="off">
                    </p>

                    <p>
                        <label for="phone">Téléphone :</label>
                        <input type="tel" id="phone" name="phone" value="<?php if(isset($_GET['phone'])) {echo $_GET['phone'];}?>" required autocomplete="off">
                    </p>
                        ...
                        <select name="ville" id="ville">
                            ...
                            <?php
                                ...
                                foreach($villes_uniques as $ville) { 
                                     ...
                                     if($_GET['ville']==$ville){ echo 'selected';}
                                     echo '>'.$ville.'</option>';
                                }
                            ?>
                        </select>
                    ...
                    <div class="resultat">
                        ...
                        <table class="resultTab">
                            ...
                            <?php foreach($travels as $travel) { if($_GET['ville']==$travel['departure']) { ?> 
                                <tr> 
